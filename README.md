...
# Concepts Practiced
1. Use of global constants
2. Use of the input function
3. Use of helper functions
4. Using a main function to control the over all flow of the program

# How to Run
1. Download or clone the repository.
2. Open Project_3.py in Python.
3. Run the program.
...
# Course 
Western Michigan University - Computer Science I
